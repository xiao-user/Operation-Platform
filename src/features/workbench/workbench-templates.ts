...
function bureauPortalPanels(startY: number): WidgetSpec[] {
  return [
    ...
    },
    {
      id: "quick-apps",
      title: "快捷应用入口",
      description: "集中展示当前角色可访问的常用应用。",
      kind: "quick-links",
      tone: "primary",
      position: { x: 0, y: startY + 5, w: 12, h: 3 },
      settings: { kind: "quick-links", menuIds: null },
      minSize: { w: 6, h: 3 },
      maxSize: { w: 12, h: 5 },
    },
    {
      ...
      kind: "list",
      tone: "neutral",
      position: { x: 0, y: startY + 8, w: 6, h: 4 },
      settings: { kind: "list", limit: 5 },
      minSize: { w: 3, h: 3 },
      maxSize: { w: 12, h: 6 },
    },
    {
      ...
      kind: "list",
      tone: "neutral",
      position: { x: 6, y: startY + 8, w: 6, h: 4 },
      settings: { kind: "list", limit: 5 },
      minSize: { w: 3, h: 3 },
      maxSize: { w: 12, h: 6 },
    },
    {
      ...
      kind: "ranking",
      tone: "primary",
      position: { x: 0, y: startY + 12, w: 3, h: 4 },
      settings: { kind: "none" },
      minSize: { w: 3, h: 4 },
      maxSize: { w: 8, h: 6 },
    },
    {
      ...
      kind: "growth",
      tone: "success",
      position: { x: 3, y: startY + 12, w: 3, h: 4 },
      settings: { kind: "none" },
      minSize: { w: 3, h: 4 },
      maxSize: { w: 8, h: 6 },
    },
    {
      ...
      kind: "list",
      tone: "neutral",
      position: { x: 6, y: startY + 12, w: 3, h: 4 },
      settings: { kind: "list", limit: 5 },
      minSize: { w: 3, h: 3 },
      maxSize: { w: 8, h: 6 },
    },
    {
      ...
      kind: "list",
      tone: "neutral",
      position: { x: 9, y: startY + 12, w: 3, h: 4 },
      settings: { kind: "list", limit: 5 },
      minSize: { w: 3, h: 3 },
      maxSize: { w: 8, h: 6 },
    },
